@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => '', 'title' => __('Ficein')])
                        ...
                        <div class="card-body ">
                            <div class="bmd-form-group{{ $errors->has('rfc') ? ' has-danger' : '' }} mt-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="rfc" class="form-control" placeholder="{{ __('RFC...') }}" value="{{ $rfc }}" required>
                                </div>
                                @if ($errors->has('rfc'))
