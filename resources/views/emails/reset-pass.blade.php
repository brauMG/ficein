                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="left">
                                                                <h3 style="color: #666666;">En nuestro sistema Ficein, tu RFC: {{$rfc}} se encuentra asignado a este correo, para establecer una contraseña y poder ingresar al sitio, entra al siguiente enlace y coloca tu RFC.<br></h3>
                                                                <a href="https://itfice.com/password/reset" target="_blank">https://itfice.com/password/reset</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p15t" align="left">
                                                                <p style="color: #999999;">Que tengas un excelente día.</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p10b es-p15r es-p15l" align="center">
                                                                <p style="font-size: 14px;">FICEIN</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
